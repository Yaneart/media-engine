...
export const DEFAULT_TORRSERVER_CONNECT_TIMEOUT_MS = 15_000;
export const DEFAULT_TORRSERVER_REQUEST_TIMEOUT_MS = 40_000;
export const DEFAULT_TORRSERVER_METADATA_TIMEOUT_MS = 60_000;

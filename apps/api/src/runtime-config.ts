...
export const DEFAULT_TORRENT_SESSION_CREATION_RATE_LIMIT_WINDOW_MS = 60_000;
export const DEFAULT_TORRENT_SESSION_CREATION_RATE_LIMIT_MAX_REQUESTS = 10;
...
export interface ApiRuntimeEnv extends NodeJS.ProcessEnv {
  ...
  MEDIA_ENGINE_TORRENT_SESSION_CREATION_RATE_LIMIT_WINDOW_MS?: string;
  MEDIA_ENGINE_TORRENT_SESSION_CREATION_RATE_LIMIT_MAX_REQUESTS?: string;
}
  ...
  return {
    ...
    torrentSessionCreationRateLimit: {
      windowMs: readIntegerEnv(
        env.MEDIA_ENGINE_TORRENT_SESSION_CREATION_RATE_LIMIT_WINDOW_MS,
        {
          name: 'MEDIA_ENGINE_TORRENT_SESSION_CREATION_RATE_LIMIT_WINDOW_MS',
          defaultValue: DEFAULT_TORRENT_SESSION_CREATION_RATE_LIMIT_WINDOW_MS,
          min: 1_000,
          max: MAX_RATE_LIMIT_WINDOW_MS,
        },
      ),
      maxRequests: readIntegerEnv(
        env.MEDIA_ENGINE_TORRENT_SESSION_CREATION_RATE_LIMIT_MAX_REQUESTS,
        {
          name: 'MEDIA_ENGINE_TORRENT_SESSION_CREATION_RATE_LIMIT_MAX_REQUESTS',
          defaultValue:
            DEFAULT_TORRENT_SESSION_CREATION_RATE_LIMIT_MAX_REQUESTS,
          min: 1,
          max: MAX_RATE_LIMIT_REQUESTS,
        },
      ),

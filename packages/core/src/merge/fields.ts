...
export function selectTitle(entries: SearchEntry[], context: MergeContext): string | undefined {
  const queryTitle =
...
export function selectDetailsTitle(
...
export function selectYear(entries: SearchEntry[], context: MergeContext): number | undefined {
...
export function selectDetailsYear(
  entries: DetailsEntry[],
  context: MergeContext,
): number | undefined {
...
export function selectReleaseDate(entries: SearchEntry[]): string | undefined {
  return maxBy(
    entries
...
export function selectDetailsReleaseDate(entries: DetailsEntry[]): string | undefined {
  return maxBy(
    entries
...
export function selectDetailsDescription(
  entries: DetailsEntry[],
  context?: MergeContext,
): string | undefined {
  const descriptions = entries
...
export function selectShortDescription(entries: SearchEntry[]): string | undefined {
...
export function selectBestDetailsImage(
  entries: DetailsEntry[],
  field: "poster" | "backdrop",
): Image | undefined {
  const images = entries
...
export function mergeRatings(entries: SearchEntry[]): Rating[] | undefined {
...
export function mergeDetailsRatings(entries: DetailsEntry[]): Rating[] | undefined {
  const ratings = new Map<string, Rating>();
...
export function mergeDetailsAlternativeTitles(
  entries: DetailsEntry[],
  selectedTitle: string,
): string[] | undefined {
  const selectedKey = normalizeTitle(selectedTitle);
...
export function mergeSources(entries: SearchEntry[]): ProviderSource[] {
...
export function mergeDetailsSources(entries: DetailsEntry[]): ProviderSource[] {
  return entries.map((entry) => ({
    provider: entry.result.source?.provider ?? entry.result.provider,
...
export function mergeDetailsImages(entries: DetailsEntry[]): Image[] | undefined {

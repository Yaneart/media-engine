...
Поиск по каталогу может работать без названия и объединять точный год, жанр и минимальную оценку:
...
Следующую страницу запрашивайте с `offset: 48`. Поисковое окно ограничено условием
`offset + limit <= 250`; если приложению нужен признак «есть ещё», запросите один дополнительный
результат, не выдавая его за общее количество у источника.
